...
def make_markov_sentences_containing(num_mix_parts, key_word,
                                     ...
                                     mix_iters=2,
                                     **kwargs):
    forward_sentences = [markov_model.make_sentence_with_start(key_word, tries=200, **kwargs) for _ in
                         range(num_mix_parts)]
    rev_sentences = [rev_markov_model.make_sentence_with_start(key_word, tries=200, **kwargs) for _ in
                     range(num_mix_parts)]
